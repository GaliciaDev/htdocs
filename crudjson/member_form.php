                    ...
                    <div class="card rounded-0 shadow">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <div class="card-title col-auto flex-shrink-1 flex-grow-1">Descripcion general</div>
                                <div class="col-atuo">
                                    <button class="btn btn-danger btn-sm btn-flat" id="add"><i class="fa fa-plus-square"></i> Agregar articulo</button>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="container-fluid">
                                ...
                                <?php else : ?>
                                    <p class="text-muted"><i>Nuevo producto</b></i></p>
                                <?php endif; ?>

...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-danger bg-gradient">
        <div class="container">
            <a class="navbar-brand" href="./">Papeleria Galicia</a>
        </div>
    </nav>
    <div class="container px-5 my-3">
        <h2 class="text-center">Catalogo de articulos escolares</h2>
        <div class="row">
                    ...
                    <div class="card rounded-0 shadow">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <div class="card-title col-auto flex-shrink-1 flex-grow-1">Productos disponibles</div>
                                <div class="col-auto">
                                    <a class="btn btn-danger btn-sm btn-flat" href="member_form.php"><i class="fa fa-plus-square"></i> Agregar Producto</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                                        ...
                                        <?php foreach ($json_data as $data) : ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <a href="delete_data.php?id=<?= $data->id ?>" class="btn btn-sm btn-outline-danger rounded-0" onclick="if(confirm(`¿Deseas eliminar el registro de <?= $data->name ?>?`) === false) event.preventDefault();">
